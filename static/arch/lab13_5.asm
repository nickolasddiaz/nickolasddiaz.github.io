...
start:              ; start label from where our code starts
    ...
    start_os_intro db '|| CSCI242 OS ||',0
    press_key db '.... Press any key ....',0

    firstname db 'Firstname : ',0
    lastname db 'Lastname : ',0
    
    display_text db '|| CSCI242 Operating System ||', 0

    os_info db 10, 'Operating System, 16-Bit, version=1.0.0',13,0

    press_key_2 db 10,'Press any key to go to graphics view',0

    window_text db 10,'Graphics in OS......', 0
    banner_text db 10,10, '    CSCI242 OS',0
...
_OS_Stage_2 :
    ...
    mov si,login_label          ; point si to firstname
    ...
    mov si,firstname          ; point si to firstname
    call print_string         ; display it on screen
...
_getfirstnameinput:
    ...
    jbe _getfirstnameinput  ; yes jump to _getfirstnameinput
    jmp .inputdone          ; else jump to inputdone

.inputdone:
    mov cx,0                ; set counter to 0
    jmp _getfirstnameinput  ; jump to _getfirstnameinput
    ret                     ; return
...
.exitinput:
    ...
    mov si,lastname               ; point si to firstname
    call print_string                   ; display it on screen
...
_getlastnameinput:
    ...
    cmp cx,5
    jbe _getlastnameinput
    
    jmp .inputdone

.inputdone:
    mov cx,0
    jmp _getlastnameinput
    ret
.exitinput:
    hlt
