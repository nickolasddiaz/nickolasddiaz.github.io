...
type settings = [WebGLRenderingContext, WebGLProgram, WebGLUniformLocation, WebGLUniformLocation, WebGLUniformLocation];
const OBJ_SIZE: number = 0.05;
...
export default class Main {
    ...
    constructor() {
		...
		this.coins = document.getElementById("coins")  as HTMLDivElement;
        ...
        this.settings = [this.gl, this.program, this.Scale, this.Rotation, this.Transform] as settings;
