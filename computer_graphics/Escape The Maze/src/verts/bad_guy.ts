...
export const triangleVertices1: number[] = getTriangleVertices(spriteMap["enemy_1"]!);
export const triangleVertices2: number[] = getTriangleVertices(spriteMap["enemy_2"]!);
export const triangleVertices3: number[] = getTriangleVertices(spriteMap["enemy_3"]!);
